      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="absolute -top-4 -left-4 w-24 h-24 border-t-2 border-l-2 border-brand-accent-blue/50 rounded-tl-xl" />
            <div className="absolute -bottom-4 -right-4 w-24 h-24 border-b-2 border-r-2 border-brand-accent-blue/50 rounded-br-xl" />
          </motion.div>
          ...
          >
            ...
            <div className="grid grid-cols-3 gap-8 mt-12 pt-12 border-t border-white/10">
              <div>
                <h4 className="text-4xl font-heading font-bold text-brand-accent-blue mb-2">7+</h4>
                <p className="text-sm text-brand-secondary uppercase tracking-wider">Years Experience</p>
              </div>
              <div>
                <h4 className="text-4xl font-heading font-bold text-brand-accent-blue mb-2">3</h4>
                <p className="text-sm text-brand-secondary uppercase tracking-wider">Professional Roles</p>
              </div>
              <div>
                <h4 className="text-4xl font-heading font-bold text-brand-accent-blue mb-2">100%</h4>
                <p className="text-sm text-brand-secondary uppercase tracking-wider">Passion for Music</p>
              </div>
            </div>
          </motion.div>
